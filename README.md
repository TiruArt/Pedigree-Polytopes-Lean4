...
**Machine-verified proof that the Membership in Pedigree Polytope Problem, (M3P) ∈ P and P = NP **
...
| ✅ **Lean 4 proof** | This repository | Machine-verified P = NP chain |
...
### Build
```bash
git clone https://github.com/YOUR-USERNAME/PedigreePolytopes-Lean4.git
cd PedigreePolytopes-Lean4
lake build
```
...
— Knuth, D. E. (2014). The Art of Computer Programming, Volume 4A: Combinatorial Algorithms, Part 1. United Kingdom: Pearson Education.